 ...
 * @Description: TODO(主题模式创建第二个消费者) 
 * @author: Jiuchuan.Shi
 * @Date: 2018年7月2日 下午1:40:38
 */
public class Consumer02 {

	// 声明队列的名称
	private static final String QUQUE_NAME = "queue_topic_name02";
	// 交换机名称
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 声明路由规则的名称
		 */
		channel.queueBind(QUQUE_NAME, EXCHANGE_DIRECT, "topic.add");
		// 只接受一条消息
		int prefetchCount = 1;
